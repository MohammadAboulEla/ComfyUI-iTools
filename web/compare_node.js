...
app.registerExtension({
  ...
  async nodeCreated(node) {
    ...
    async function analyzeImages() {
      if(imagesTracked.length > 1) return;
    ...
    function togglingImages(imgName) {
    ...
    function createButtons(startVisible = true) {
      ...
      a = new SmartButton(bx, by, 18, 20, node, "A");
      ...
      b = new SmartButton(bx + 25, by, 18, 20, node, "B");
      ...
      c = new SmartButton(bx + 25 + 25, by, 18, 20, node, "|");
      ...
      o = new SmartButton(bx + 25 + 25 + 25, by, 18, 20, node, "O");
